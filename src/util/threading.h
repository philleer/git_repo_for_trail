#ifndef SRC_BASE_THREADING
#define SRC_BASE_THREADING
...
// namespace std {
//    template<typename T>
//    struct _Reference_wrapper_base<T> {};

//    template<typename T>
//    struct _Weak_result_type<std::function<T>(void*)> {};
// }
